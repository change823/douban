...
<div class="w-full mx-auto">
  <div
    ...
    class="bg-white border-2 border-[#007722] shadow-[8px_8px_0px_0px_rgba(0,119,34,0.2)] p-5 md:p-8 w-full mx-auto text-slate-800 font-sans relative overflow-hidden group"
  >
