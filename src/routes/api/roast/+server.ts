...
import { model } from '$lib/server/gemini';
...
export const POST: RequestHandler = async ({ request }: { request: Request }) => {
    ...
    Analyze the following list of user records (movies/books/music) from Douban.
        ...
        4. "scores": specific scores (0-100) for "artistic", "mainstream", "niche", "emotional", "acg".
	...
	try {
        ...
        console.log('Gemini Raw Output:', text.slice(0, 100) + '...'); // Log first 100 chars for debug
