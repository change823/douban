...
* **触发条件：** 影：《瑞士军刀男》、《约翰·威尔逊的十万个怎么做》、**定格动画**。漫：《瑞克和莫蒂》、《探险活宝》、《JOJO的奇妙冒险》。书：《银河系漫游指南》、各种无厘头漫画。 评分通常很高，关键词里常出现“哈哈哈哈”、“神经病”、“卧槽”、“好怪再看一眼”。
    ...
    Analyze the following list of user records (movies/books/music) from Douban.
        ...
        **CRITICAL STYLE FOR THOUGHTS:**
        ...
        The JSON should follow this structure:
        {
            ...
            "roast": "A 300+ charruthless roast about their taste contradictions...",
